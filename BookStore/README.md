...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8fcc8049-d7b5-4834-9b96-99693348b669
```

> `8fcc8049-d7b5-4834-9b96-99693348b669` is the password of the certificate, you can change it to any password you want.
